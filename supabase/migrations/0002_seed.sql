...
begin
  ...
  insert into public.products (game_id, label, price, old_price, coins, desc, icon_color, sort_order) values
  ...
  insert into public.products (game_id, label, price, old_price, coins, desc, icon_color, badge, sort_order) values
